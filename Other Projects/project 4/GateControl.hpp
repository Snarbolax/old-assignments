...
typedef map<CardNumber, Transaction>	TransactionMap;

typedef	AuthorizationMap::iterator		AuthorizationIterator;
typedef	TransactionMap::iterator		TransactionIterator;
...
class	GateControl
{
	public:
		...
		bool	GetOneAuthorization(CardNumber number, Authorization& authorization);
	...
	private:
		...
		AuthorizationVector authorizationVector_;
